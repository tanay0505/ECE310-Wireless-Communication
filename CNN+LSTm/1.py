...
data_directory = r"H:\Wireless Dataset\BVP"
...
model.fit(
    ...
    epochs=10,  # Reduce epochs for quicker testing, increase as needed
    validation_data=(X_test, y_test),  # Validation data defined here
